...
1. **PR aciklama sablonunu oku:**
   ...
   - Yoksa kullaniciya `humanlayer thoughts` kurulumunun eksik oldugunu ve `thoughts/shared/pr_description.md` yolunda PR aciklama sablonu olusturmasi gerektigini bildir
